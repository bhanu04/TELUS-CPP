  ...
  <serviceElementList>
    <serviceElement>
      ...
      <ServiceEndpointAttributes>
        ...
        <oldClasifier>DSCP</oldClasifier>
            ...
            <serviceRequestConfig>   <!-- Insert document root element (<serviceRequestConfig>) here -->
               ...
               <xsl:for-each select="/ns2:ServiceRequest/serviceElementList/serviceElement/ServiceEndpointAttributes[vendorType = 'Juniper']">
                 ...
                 <!-- <xsl:variable name="recordOPType" select="/*/serviceElementList/serviceElement/operation"/>-->
                  ...
                  <xsl:variable name="beService1" select="beService"/>
                  <xsl:variable name="classifier" select="classifier"/>
                  <xsl:variable name="oldClassifier" select="oldClassifier"/>
                  ...
                  <xsl:variable name="oldQosType" select="oldQosType"/>
                  ...
                  <xsl:variable name="vpnAlias" select="vpnAlias"/>
                  ...
                  <xsl:variable name="trafic-control-profile-name1"><!-- TO BE DELETED -->
                     <xsl:choose>
                        <xsl:when test="$efService = 'true'">
                           <xsl:value-of select="concat('IP_NTWKSv2','_',  $accessRate,'_', 'EF', '_', $AF3,'_',  $AF2,'_',  $AF1)" />
                        </xsl:when>
                     ...
                     <configuration>               
                             ...
                             <interfaces>
                                 <xsl:if test="$endPointServiceType = 'TML3' or $endPointServiceType = 'TML3A'">
                                    <interface>
                                       ...
                                       <!--<junos:comment>/* test tes test 11*/</junos:comment>-->
                                       ...
                                       <unit>
                                          <!--<junos:comment><xsl:value-of select="$VLAN_ID"/></junos:comment>-->
                                          <name>
                                 ...
                                 <xsl:choose>
                                    <xsl:when test="$qosType != $oldQosType and $oldQosType ='QoS per VPN'">
                                       <interface-set>
                                    ...
                                    <xsl:when test="$qosType != $oldQosType and $oldQosType ='QoS per Access'">
                                 ...
                                 <xsl:if test="$qosType != $oldQosType and $oldQosType ='QoS per Access'" >
                                   <interface-set operation="delete">
                                       <name>
                                          <xsl:value-of select="$ciuName"/>
                                       </name>
                              ...
                              <xsl:if test="$efService = 'true11'"> <!-- NOT IN PHASE ONE.make it true later in phase 2 -->
                                 <firewall>
                                    <!-- Policer used in all cases below.  These rates come from a table that must be followed -->
                                    <!--   CML3
                                    <policer replace="replace">
                                          <name>
                                    ...
                                    <xsl:if test="$isIPv6Selected = 'true' and $efService = 'true' and $endPointServiceType = 'CML3'">
                                       <family>
                                          <inet6>
                                             <filter>
                                 ...
                                 <xsl:if test="$endPointServiceType = 'TML3' or $endPointServiceType = 'TML3A'">
                                      ...
                                      <xsl:if test="$operationalMode != 'TST'">
                                         <prefix-list>
                                            ...
                                            <xsl:for-each select="prefixListBeforeUpdate/prefixListBeforeUpdate/e">
                                               <xsl:variable name="route" select="prefixList" />
                                               <xsl:if test="$route != null or $route != ''">
                                                  <prefix-list-item operation="delete">
                                                     <name> 
                                      ...
                                      <unit>
                                         <name replace="replace">
                                          ...
                                          <xsl:choose>
                                             ...
                                             <xsl:when test="$qosType ='QoS per Access'"> <!-- $qosType != $oldQosType and  -->
                                                <output-traffic-control-profile>
                                                   <profile-name replace="replace">
                                                      <xsl:value-of select="$trafic-control-profile-name"/>
                                                  </profile-name>
                                             ...
                                             <xsl:when test="$qosType != $oldQosType and $oldQosType = 'QoS per Access' and $qosType ='QoS per VPN'"> <!-- $qosType != $oldQosType and  -->
                                                <output-traffic-control-profile>
                                                   <profile-name operation="delete">
                                                      <xsl:value-of select="$trafic-control-profile-name"/>
                                                   </profile-name>
                                                </output-traffic-control-profile>
                                             </xsl:when>
                        ...
                        <class-of-service>
                           ...
                           <!-- if this scheduler-map exists using the passed in variables - if yes, use existing, if not must create it.
                              ...
                              <scheduler-maps>
                                 <name>
                                    <xsl:value-of select="$schedularMapNameNOEF"/>
                                 </name>
                                 <forwarding-class>
                                    <name>FC_TOLL_VOICE_AND_SIGNALING</name>
                                    <scheduler>RP</scheduler>
                             ...
                             <xsl:variable name="traficControlProfile">
                              ...
                              <interfaces>
                                 <interface>
                                    ...
                                    <xsl:choose>
                                       <xsl:when test="$interfaceSetCount > '1'">
